...
POSTRACI is a vibecoded, high-performance TCP port scanner that leverages **Boost.Asio** for network operations and **multi-threading** for blazing-fast concurrent port scanning. Built from the ground up with clean C++1, it features a professional CMake build system, color-coded terminal output, and flexible targeting options.
...
- 🚫 **No dependencies hell** — Just Boost and a C++ compiler
